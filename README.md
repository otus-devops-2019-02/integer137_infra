...
"Пересоздали инфраструктуру, используя terraform."
"Провели настройку приложения командой ````ansible-playbook site.ymlansible-playbook site.yml````."
"Провели проверку работоспособности приложения."
"Задание с *. Для динамического инвентори выбран плагин gcp_compute. Создан  файл gcp.yml с настройками для плагина gcp_compute. В файл ansible.cfg внесены соответствующие изменения. Для запуска плейбука используется команда:"
